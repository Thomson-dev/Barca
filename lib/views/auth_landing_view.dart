    ...
    return AuthScaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          _AuthOptionButton(
            label: 'Email',
            icon: const Icon(Iconsax.sms, size: 25, color: Colors.black),
          ...
          _AuthOptionButton(
            label: 'Google',
            icon: Image.asset(
              'lib/assets/images/goggle.png',
              width: 25,
              height: 30,
              errorBuilder: (_, __, ___) =>
                  const Icon(Iconsax.global, size: 25, color: Colors.black),
            ),
          ...
          _AuthOptionButton(
            ...
            icon: Image.asset(
              ...
              height: 30,
              errorBuilder: (_, __, ___) =>
                  const Icon(Iconsax.profile, size: 25, color: Colors.black),
            ),
